...
from investment_tracker.quant.phase4.gate3_runner.models import AttemptRecord, CampaignResultSet, PositionReceipt
from investment_tracker.quant.phase4.gate3_runner.state import RunnerStateStore
from investment_tracker.quant.phase4.preregistration.canonical import artifact_envelope_identity, canonical_sha256
...
def test_receipt_requires_matching_attempt_before_publish(tmp_path: Path):
    ...
    forged = PositionReceipt(
        ...
        trial_id=record.trial_id,
        result_artifact=identity("phase4_gate3_candidate_result", "results/forged.json", "6" * 64),
        result_status="UNKNOWN",
    )
